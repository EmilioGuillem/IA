...
# ,torch_dtype=torch.float16, device_map='auto') 
            ...
            self.model = AutoModelForCausalLM.from_pretrained(self.path_to_model, torch_dtype=torch.bfloat16, device_map='cpu', token="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") 
